...
> **派工解冻**：G1–G9 已于 2026-09-08 全部评审定案（用户逐条拍板采纳推荐解，登记 `decisions.md` **D-30–D-38**）；全部 8 票就绪态终审完成，按编号顺序派工。T8 真实实测重跑开工前需用户确认 key（照 M3 issue 08 流程）——**key 门槛已于 2026-09-08 由用户确认解除并授权预算，T8 执行完毕**。
...
| 08 | 真实实测重跑与收尾（**开工前需用户确认 key**） | T8 | 05, 06, 07 | resolved（2026-09-08） |
